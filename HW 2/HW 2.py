...
This program determines how many years it takes for the Mexican population to 
exceed the US population, as well as printing out the population for each year. 
The second half of the program follows the troubleshooting chart for a diesel 
engine. It takes in user input and guides them through which steps to take. 

Question 1
The current population of the United States is about 328.2 million and that 
the population decreases 0.53 percent annually. The current population of 
Mexico is 127.6 million and that the population increases 1.06 percent 
annually. Assume the population percentages for both countries remain the same,
write a program that displays the populations for the two countries every year 
until the population of Mexico exceeds that of the United States,and display 
the number of years it took. 
Question 2
Observe the Troubleshooting Chart for Diesel Engine below. Write a program 
based on the given chart. Make sure your program validates the input data. For
example, value 50x is invalid, it should be 50.
'''
