...
score2 = eval(input("Enter student score: "))

# Make sure that student1 is for the highest and student2 is the second highest
...
for i in range(numberOfStudents - 2):
  ...
  if score > score1:
    ...
    student1, student2 = student, student1 # Student1 is now the highest
